...
from vrc_t70.manager.misc import get_random_session_id
...
@mock.patch("vrc_t70.manager.misc.random.getrandbits", side_effect=[0, 0, 42])
...
@mock.patch("vrc_t70.manager.misc.random.getrandbits", side_effect=[123, 123, 42])
...
@mock.patch("vrc_t70.manager.misc.random.getrandbits", side_effect=[123, 123, 0, 42])
