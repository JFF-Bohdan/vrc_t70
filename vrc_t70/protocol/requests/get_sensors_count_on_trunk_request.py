...
class GetSensorsCountOnTrunkRequest(base_request.BaseRequest):
    """
    Requests sensors count on a trunk
    """
    def __init__(
            self,
            trunk_number: int,
        ...
        super().__init__(
            address=address,
            request_id=request_codes.RequestCodes.GET_SENSORS_COUNT_ON_TRUNK,
